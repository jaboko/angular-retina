...
(function (angular, undefined) {
  'use strict';
  var infix = '@2x', data_url_regex = /^data:([a-z]+\/[a-z]+(;[a-z\-]+\=[a-z\-]+)?)?(;base64)?,(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/]{2}==|[A-Za-z0-9+/]{3}=)?$/, pattern = /.*/;
      ...
      return function (scope, element, attrs) {
        ...
        attrs.$observe('ngSrc', function (value) {
          ...
          if (isRetina && typeof $window.sessionStorage === 'object' && element[0].tagName === 'IMG' && !value.match(data_url_regex)) {
            var autoSize = !attrs.hasOwnProperty(autoSize) || attrs.autoSize ? true : false;
            if (autoSize) {
